...
### INSTALL SCRIPT
<pre><code>apt install -y wget screen && wget -q https://raw.githubusercontent.com/myridwan/scriptvps/ipuk/main.sh && chmod +x main.sh && screen -S install ./main.sh</code></pre>
